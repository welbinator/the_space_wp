...
function the_space_coworking_scripts() {
	wp_enqueue_style( 'the-space-coworking-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'the-space-coworking-style', 'rtl', 'replace' );

	wp_enqueue_script( 'the-space-coworking-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
